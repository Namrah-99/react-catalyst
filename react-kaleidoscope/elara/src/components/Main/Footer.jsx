...
export default function Footer() {
  ...
  return (
    <>
      <div className="w-4/5 mx-auto grid grid-cols-3 grid-rows-1 gap-4 text-gray-600 py-8">
      ...
      <div className="bg-[#f0f0f0] py-8">
        <div className="w-4/5 mx-auto grid grid-cols-2 grid-rows-1 gap-4">
          <div className="md:w-3/4 flex flex-col gap-y-4">
            ...
            <div className="flex justify-between">
              <input
                type="text"
                className="w-3/4 appearance-none border border-gray-300 py-2 px-4 bg-white text-gray-600 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent"
