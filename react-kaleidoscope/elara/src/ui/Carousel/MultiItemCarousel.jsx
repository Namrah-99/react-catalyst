...
export default function MultiItemCarousel({ data }) {
  console.log(data);
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="flex justify-between absolute top left w-full h-full">
        <button
          onClick={movePrev}
          className="hover:bg-gray-900/75 text-white w-10 h-full text-center opacity-75 hover:opacity-65 disabled:opacity-25 disabled:cursor-not-allowed z-10 p-0 m-0 transition-all ease-in-out duration-300"
